...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> adapterUbicacionS = new ArrayAdapter<>(this, android.R.layout.simple_spinner_item, UbicacionS);

        Categoria.setAdapter(adapterCategoriaS);
        Ubicacion.setAdapter(adapterUbicacionS);
    ...
    public void RegistrarProducto(View view){
        ...
        if (!fila.moveToFirst()){
            ...
            Toast.makeText(this, "El ID ya está registrado", Toast.LENGTH_SHORT).show();
        }
